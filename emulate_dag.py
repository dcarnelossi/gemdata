...
def category(integration_id):    
    ...
    from vtex.modules import category_concurrent as category
...
def orders_list(integration_id):    
    ...
    try:
        ...
        orders_list.set_globals(api_conection_info, data_conection_info, coorp_conection_info, start_date=start_date, end_date=end_date)
...
def orders_items(integration_id):    
    ...
    try:
        ...
        orders_items.set_globals(api_conection_info, data_conection_info, coorp_conection_info)
...
def orders_totals(integration_id):    
    ...
    from vtex.modules import orders_totals
    try:
        
        orders_totals.set_globals(api_conection_info, data_conection_info, coorp_conection_info)
...
def orders_shipping(integration_id):    
    ...
    from vtex.modules import orders_shipping
    try:
        
        orders_shipping.set_globals(api_conection_info, data_conection_info, coorp_conection_info)
