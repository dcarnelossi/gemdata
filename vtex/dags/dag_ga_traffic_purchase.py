...
with DAG(
    "ga-4-ga-traffic-purchase",
    schedule_interval=None,
    catchup=False,
    default_args=default_args,
    tags=["import", "trafficpurchase", "ga"],
    ...
    def run_python(**kwargs):
        ...
        from gemdata.vtex.modules.ga import ga_traffic_purchase
       ...
       #         min_date = end_date - timedelta(days=735)
        ...
        #        min_date = end_date - timedelta(days=735)
            ...
            ga_traffic_purchase.set_globals(
                api_conection_info,
                data_conection_info,
    ...
    trigger_dag_ga_5_sessions_technology = TriggerDagRunOperator(
    ...
    pyhton_task >>  trigger_dag_ga_5_sessions_technology 
