...
with DAG(
    "ga-6-sessions-geolocation",
    schedule_interval=None,
    catchup=False,
    default_args=default_args,
    tags=["import", "geolocation", "ga"],
    ...
    def run_python(**kwargs):
        ...
        from modules.ga import ga_sessions_geolocation
       ...
       #         min_date = end_date - timedelta(days=735)
        ...
        #        min_date = end_date - timedelta(days=735)
            ...
            ga_sessions_geolocation.set_globals(
                api_conection_info,
                data_conection_info,
    ...
    trigger_dag_ga_7_funnel_events = TriggerDagRunOperator(
    ...
    pyhton_task >>  trigger_dag_ga_7_funnel_events 
