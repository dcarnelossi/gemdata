...
with DAG(
    ...
    def listcategories(**kwargs):
        ...
        from modules.nuvemshop import nuvem_categories  
    ...
    trigger_dag_orders = TriggerDagRunOperator(
        ...
        trigger_dag_id="nuvem-2-Products",  # Substitua pelo nome real da sua segunda DAG
        conf={
