...
with DAG(
    ...
    def listcategories(**kwargs):
        ...
        from gemdata.vtex.modules.nuvemshop import nuvem_products  
    ...
    trigger_dag_orders = TriggerDagRunOperator(
        ...
        trigger_dag_id="nuvem-3-Orders",  # Substitua pelo nome real da sua segunda DAG
        conf={
