...
with DAG(
    ...
    def listorders(**kwargs):
        ...
        from gemdata.vtex.modules.lojaintegrada import li_list_orders   
        ...
        try:
            ...
            li_list_orders.set_globals(
                api_conection_info,
                data_conection_info,
                coorp_conection_info,
                type_api= 'list_orders',
    ...
    trigger_dag_orders = TriggerDagRunOperator(
        ...
        trigger_dag_id="LI-5-Orders",  # Substitua pelo nome real da sua segunda DAG
        conf={
    ...
    try:
        listorders_task = listorders()


        listorders_task >>  trigger_dag_orders 
