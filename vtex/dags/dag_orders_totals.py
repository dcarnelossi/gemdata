...
with DAG(
    ...
    trigger_dag_imports = TriggerDagRunOperator(
        ...
        trigger_dag_id="6-ImportVtex-Orders-Shipping",  # Substitua pelo nome real da sua segunda DAG
        conf={
    ...
    orders_totals_task >> trigger_dag_imports
