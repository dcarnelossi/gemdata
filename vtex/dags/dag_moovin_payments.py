...
with DAG(
    ...
    trigger_dag_orders = TriggerDagRunOperator(
        ...
        trigger_dag_id="moovin-5-Shippings",  # Substitua pelo nome real da sua segunda DAG
        conf={
    ...
    try:
        listpayments_task = listpayments()


        listpayments_task >>  trigger_dag_orders 
