...
with DAG(
    ...
    def run_python(**kwargs):
        ...
        from gemdata.vtex.modules.ga import ga_traffic
    ...
    trigger_dag_ga_4_traffic_purchase = TriggerDagRunOperator(
    ...
    pyhton_task >>  trigger_dag_ga_4_traffic_purchase 
