...
with DAG(
    ...
    trigger_dag_orders_payments = TriggerDagRunOperator(
        task_id="trigger_dag_orders_payments",
        trigger_dag_id="LI-7-Orders-Payments",  # Substitua pelo nome real da sua segunda DAG
        conf={
    ...
    try:
        ...
        orders_details_task >>  trigger_dag_orders_payments 
