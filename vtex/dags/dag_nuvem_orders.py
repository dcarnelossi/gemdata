...
with DAG(
    ...
    def listcategories(**kwargs):
        ...
        from gemdata.vtex.modules.nuvemshop import nuvem_orders  
    ...
    trigger_dag_orders = TriggerDagRunOperator(
        ...
        trigger_dag_id="nuvem-4-Items",  # Substitua pelo nome real da sua segunda DAG
        conf={
