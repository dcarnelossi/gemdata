        ...
        try:      
            # Conecte-se ao PostgreSQL e execute o script
                ...
                query_default_orders_lastyear = f"""
                    ...
                    where date_trunc('day', creationdate) = date_trunc('day',(CURRENT_DATE- INTERVAL '1 year')  AT TIME ZONE 'America/Sao_Paulo' )
                ...
                if (plataforma=='vtex'):
                    ...
                    WITH address AS (
                        ...
                        select 
                            ...
                            to_char(date_trunc('hour',o.creationdate  AT TIME ZONE 'America/Sao_Paulo' ), 'YYYY-MM-DD') as creationdate  
                            , EXTRACT(YEAR FROM date_trunc('hour',o.creationdate  AT TIME ZONE 'America/Sao_Paulo' ))::int                    AS ano
                            , EXTRACT(HOUR FROM date_trunc('hour',o.creationdate  AT TIME ZONE 'America/Sao_Paulo' ))::int                    AS hora
                    ...
                    query = f"""
                                ...
                                where 
                                date_trunc('day',o.createdat   AT TIME ZONE 'America/Sao_Paulo' ) = date_trunc('day',(CURRENT_TIMESTAMP AT TIME ZONE 'America/Sao_Paulo')::date)
                                and 
                       ...
                       query = f"""
                                ...
                                WITH realtime_orders AS (
                                select 
                                to_char(date_trunc('hour',o.created_at  AT TIME ZONE 'America/Sao_Paulo' ), 'YYYY-MM-DD') as creationdate  
                                , EXTRACT(YEAR FROM date_trunc('hour',o.created_at  AT TIME ZONE 'America/Sao_Paulo' ))::int                    AS ano
                                , EXTRACT(HOUR FROM date_trunc('hour',o.created_at  AT TIME ZONE 'America/Sao_Paulo' ))::int                    AS hora
                                ...
                                where 
                                date_trunc('day',o.created_at  AT TIME ZONE 'America/Sao_Paulo' ) =  date_trunc('day',(CURRENT_TIMESTAMP   AT TIME ZONE 'America/Sao_Paulo')::date) 
                                and 
