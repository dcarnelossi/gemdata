...
with DAG(
    ...
    def orders(**kwargs):
        ...
        from modules.vtex import realtime_vtex_orders

        try:
            query = f"""truncate table "{integration_id}".realtime_vtex_orders;""" 
            ...
            realtime_vtex_orders.set_globals(
                api_conection_info,
                data_conection_info,
