...
with DAG(
    ...
    tags=["moovin", "lista_categories", "IMPORT"],
    ...
    def listcategories(**kwargs):
        ...
        from gemdata.vtex.modules.moovin import moovin_list_categories  
        ...
        try:
            ...
            moovin_list_categories.set_globals(
                api_conection_info,
                data_conection_info,
    ...
    trigger_dag_orders = TriggerDagRunOperator(
        ...
        trigger_dag_id="moovin-3-Orders",  # Substitua pelo nome real da sua segunda DAG
        conf={
    ...
    try:
        listcategories_task = listcategories()


        listcategories_task >>  trigger_dag_orders 
