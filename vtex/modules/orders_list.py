...
def get_orders_list_pages(query_params):
    ...
    return make_request(api_conection_info['VTEX_Domain'], "GET", f"api/oms/pvt/orders", params=query_params, headers=api_conection_info['headers'])
...
def process_order(order):
    try:
        ...
        writer = WriteJsonToPostgres(data_conection_info, order, 'orders_list', 'orderid')
        writer.upsert_data()
