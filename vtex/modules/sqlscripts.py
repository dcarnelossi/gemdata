def vtexsqlscripts(schema, user):
    ...
    CREATE INDEX idx_orders_items_orderid ON "{schema}".orders_items USING btree (orderid);
    ...
    CREATE INDEX idx_orders_totals ON "{schema}".orders_totals USING btree (orderid);
