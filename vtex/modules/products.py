...
def get_products_by_category(category_id):
    try:
        ...
        data = make_request(api_conection_info['VTEX_Domain'], "GET","api/catalog_system/pvt/products/GetProductAndSkuIds?", params=query_params, headers=api_conection_info['headers'])
...
def get_product_by_id(product_id):
    return make_request(api_conection_info['VTEX_Domain'], "GET", f"api/catalog/pvt/product/{product_id}", headers=api_conection_info['headers'])
