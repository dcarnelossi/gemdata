        ...
        try: 
            ...
            for edge in edges:
                ...
                transformed_order = {
                            ...
                            "closedat": order_data.get("closedAt", None) if order_data.get("closedAt") else None,
                            "cancelledat": order_data.get("cancelledAt", None) if order_data.get("cancelledAt") else None,
                            "cancelreason": order_data.get("cancelReason", None)if order_data.get("cancelReason") else None,
                            "currencycode": order_data.get("currencyCode", None) if order_data.get("currencyCode") else None,
