...
def get_details_orders(column_orders,table_ref):
    query = f"SELECT {column_orders},order_id  FROM {table_ref} where data_insercao >= '{start_date_info}' ORDER BY order_id"
...
#set_globals("a","integrations-data-dev","appgemdata-homol","items","nuvem_orders")