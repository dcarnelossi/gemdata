...
def gerar_pdf_analise(celular,integration,extensao,diretorio,caminho_pdf_blob):
    ...
    # Inserir um espaço
    pdf.ln(2)
    verde_texto = "1- Verde: Produtos com crescimento acentuado e alta representatividade financeira. A recomendação é manter a estratégia atual."
     # Adicionar a descrição normal
    pdf.set_font('Helvetica', '', 10)
    pdf.multi_cell(0, 6, verde_texto)
   
    pdf.ln(2)
    vermelho_texto = "2- Vermelho: Produtos com queda significativa no crescimento, apesar de sua alta representatividade financeira."
     # Adicionar a descrição normal
    pdf.set_font('Helvetica', '', 10)
    ...
    azul_texto = "3- Azul: Produtos com crescimento moderado a elevado e alta ou média representatividade financeira. A estratégia atual deve ser mantida com monitoramento contínuo."
     # Adicionar a descrição normal
    pdf.set_font('Helvetica', '', 10)
    pdf.multi_cell(0, 6, azul_texto)
    pdf.ln(2)
    amarelo_texto = "4- Amarelo: Produtos com queda moderada no crescimento, mas com alta ou média representatividade financeira."
     # Adicionar a descrição normal
    pdf.set_font('Helvetica', '', 10)
    pdf.multi_cell(0, 6, amarelo_texto)
    ...
    # Adicionar o texto principal
    texto_intro2 = f"colocar um texto aqui falando do detalhamento dos produtos........................................................................................................................ "
    
    pdf.multi_cell(0, 6, texto_intro2)
    # Inserir um espaço
    pdf.ln(2)

    pdf.image(f"{diretorio}/tabela_detalhada{celular}.png", x = 7,y= 75,w=195)
